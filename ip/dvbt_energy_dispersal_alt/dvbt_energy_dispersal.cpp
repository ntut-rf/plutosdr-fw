...
#pragma HLS INTERFACE axis port=OUT
    ...
    // Get I/O signature
    //int input_signature = 1; //impl.input_signature()->sizeof_stream_item(0);
    //int output_signature = 1; //impl.output_signature()->sizeof_stream_item(0);
    ...
    // Allocate I/O buffer
    unsigned char in[1024];//[input_signature*ninput_items[0]];
    unsigned char out[1024];//[output_signature*noutput_items];
